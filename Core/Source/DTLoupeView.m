...
- (void)setTouchPoint:(CGPoint)touchPoint
{
    ...
    CGPoint convertedLocation = [_targetView.window convertPoint:pointInWindow fromWindow:_targetView.window];
...
- (void)presentLoupeFromLocation:(CGPoint)location
{
    ...
    // calculate transform
    CGPoint convertedLocation = [_targetView convertPoint:location toView:_targetView.window];
